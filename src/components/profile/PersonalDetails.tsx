...
const PersonalDetails: React.FC<PersonalDetailsProps> = ({
  ...
  const toggleSection = (
    section: "basicInfo" | "education" | "workExperience" | "otherInfo"
  ) => {
  ...
  return (
    <div className="space-y-8">
          ...
          <div className="p-6 relative">
            ...
            <div className="space-y-4">
              ...
              {personalDetails.relationshipStatus && (
                <div className="flex items-start gap-3">
                  <div className="flex-shrink-0 mt-1">
                    <Heart className="h-4 sm:h-5 w-4 sm:w-5 text-gray-400" />
                  </div>
                  <div>
                    <h3 className="text-xs sm:text-sm font-medium text-gray-500">
                      Relationship Status
              ...
              {personalDetails.languages &&
                personalDetails.languages.length > 0 && (
                  <div className="flex items-start gap-3">
                    <div className="flex-shrink-0 mt-1">
                      <Globe className="h-4 sm:h-5 w-4 sm:w-5 text-gray-400" />
                    </div>
                    <div>
                      <h3 className="text-xs sm:text-sm font-medium text-gray-500">
                        Languages
              ...
              {isCurrentUser &&
                ...
                (!personalDetails.languages ||
                  ...
                  <div className="mt-4 text-right">
                    <button
                      className="text-rose-600 text-xs sm:text-sm font-medium"
                      onClick={handleEditBasicInfo}
                    >
      ...
      <div className="bg-white shadow-sm rounded-lg overflow-hidden">
        ...
        >
          <div className="flex items-center gap-2">
            <GraduationCap className="h-4 sm:h-5 w-4 sm:w-5 text-rose-500" />
              ...
              <div className="space-y-6">
                {personalDetails.education.map((edu) => (
                  ...
                  >
                    ...
                    <h3 className="text-base sm:text-lg font-medium pr-8">
                      {edu.institution}
                    </h3>
      ...
      <div className="bg-white shadow-sm rounded-lg overflow-hidden">
        ...
        >
          <div className="flex items-center gap-2">
            <Briefcase className="h-4 sm:h-5 w-4 sm:w-5 text-rose-500" />
            <h2 className="text-base sm:text-xl font-semibold">
              Work Experience
            </h2>
          </div>
      ...
      <div className="bg-white shadow-sm rounded-lg overflow-hidden">
        ...
        >
          <div className="flex items-center gap-2">
            <BookOpen className="h-4 sm:h-5 w-4 sm:w-5 text-rose-500" />
            <h2 className="text-base sm:text-xl font-semibold">
              Other Information
            </h2>
          </div>
              ...
              {personalDetails.interests &&
                personalDetails.interests.length > 0 && (
                  <div className="relative">
                    ...
                    <h3 className="text-sm sm:text-base font-medium text-gray-700 mb-2 pr-8">
                      Interests & Hobbies
                    </h3>
                    <div className="flex flex-wrap gap-2">
                      {personalDetails.interests.map((interest) => (
                        <Badge
                          key={interest}
                          variant="secondary"
                          className="bg-rose-50 text-rose-600 hover:bg-rose-100 text-xs sm:text-sm"
                        >
                          {interest}
                        </Badge>
                      ))}
