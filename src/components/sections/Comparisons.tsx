...
export default function Comparisons() {
  ...
  const comparisons = [
    ...
    },
    {
      ...
      solution:
        "Family tree shows connections and helps relatives find each other",
    },
    {
      problemIcon: <FileX className="w-6 h-6 text-red-500" />,
      problem:
        "Family history, stories, and memories get lost over generations",
      solutionIcon: <Archive className="w-6 h-6 text-rose-500" />,
      solution:
        "	Store stories, videos, and life moments for future generations to revisit",
    },
  ];
